...
export function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      className={cn(
        "peer inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border border-line transition-colors data-[state=checked]:bg-accent data-[state=unchecked]:bg-panelAlt",
        className,
      )}
      {...props}
    >
